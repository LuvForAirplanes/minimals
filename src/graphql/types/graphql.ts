...
export type QuickUserProfileQuery = { __typename?: 'Query', userProfileImage?: Array<any> | null, quickUserProfile: (
    { __typename?: 'QuickUserEdit' }
    & { ' $fragmentRefs'?: { 'QuickUserEditorFragment': QuickUserEditorFragment } }
  ) };
