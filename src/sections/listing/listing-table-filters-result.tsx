...
import { IListingTableFilters, IListingTableFilterValue } from 'src/types/listing';

// ----------------------------------------------------------------------

type Props = StackProps & {
  filters: IListingTableFilters;
  onFilters: (name: string, value: IListingTableFilterValue) => void;
  //
...
export default function ListingTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
