...
import ListingReviewNewForm from './listing-review-new-form';
...
export default function ListingDetailsReview({ ratings, reviews, listingId }: Props) {
  ...
  return (
    <>
      ...
      <ListingReviewList reviews={reviews} />

      <ListingReviewNewForm open={review.value} listingId={listingId} onClose={review.onFalse} />
    </>
  );
}
