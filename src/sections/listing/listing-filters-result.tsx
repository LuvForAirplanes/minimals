...
import { IListingFilters, IListingFilterValue } from 'src/types/listing';

// ----------------------------------------------------------------------

type Props = StackProps & {
  filters: IListingFilters;
  onFilters: (name: string, value: IListingFilterValue) => void;
  //
  canReset: boolean;
...
export default function ListingFiltersResult({
  filters,
  onFilters,
  //
  canReset,
